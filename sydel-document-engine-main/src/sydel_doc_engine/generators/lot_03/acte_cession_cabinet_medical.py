...
OUTPUT_FILENAME = "acte_cession_cabinet_medical.docx"


class ActeCessionCabinetMedicalGenerator:
    """Generateur from-scratch de l'acte de cession d'un cabinet medical."""
